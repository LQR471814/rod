...
import (
	...
	"github.com/LQR471814/rod/lib/cdp"
...
// Doc for environment variables: https://pkg.go.dev/github.com/LQR471814/rod/lib/defaults
...
// List of cdp API: https://github.com/LQR471814/rod/tree/main/lib/proto
...
func Example_load_extension() {
	...
	u := launcher.New().
		...
		// You can use XVFB to get rid of it: https://github.com/LQR471814/rod/blob/main/lib/examples/launch-managed/main.go
		Headless(false).
		MustLaunch()
